  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <div style={{ color: '#6A9955', fontSize: '20px', marginBottom: '20px' }}>
            // cv builder for developers
          </div>
          <div style={{ color: '#d4d4d4', fontSize: '56px', fontWeight: 700, lineHeight: 1.1 }}>
            Your Resume,
          </div>
          <div
            style={{
        ...
        >
          ...
          >
            <div style={{ color: '#d4d4d4', fontSize: '14px' }}>resume.ts</div>
          </div>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '16px' }}>
            <div style={{ display: 'flex' }}>
              <span style={{ color: '#858585', width: '36px' }}>1</span>
            ...
            <div style={{ display: 'flex' }}>
              <span style={{ color: '#858585', width: '36px' }}>2</span>
            ...
            <div style={{ display: 'flex' }}>
              <span style={{ color: '#858585', width: '36px' }}>3</span>
            ...
            <div style={{ display: 'flex' }}>
              <span style={{ color: '#858585', width: '36px' }}>4</span>
            ...
            <div style={{ display: 'flex' }}>
              <span style={{ color: '#858585', width: '36px' }}>5</span>
            ...
            <div style={{ display: 'flex' }}>
              <span style={{ color: '#858585', width: '36px' }}>6</span>
              <span style={{ color: '#d4d4d4' }}>{'}'}</span>
            </div>
            <div style={{ display: 'flex' }}>
              <span style={{ color: '#858585', width: '36px' }}>7</span>
            </div>
            <div style={{ display: 'flex' }}>
              <span style={{ color: '#858585', width: '36px' }}>8</span>
            ...
            <div style={{ display: 'flex' }}>
              <span style={{ color: '#858585', width: '36px' }}>9</span>
              <span style={{ color: '#9CDCFE', marginLeft: '24px' }}>name</span>
              <span style={{ color: '#d4d4d4' }}>:</span>
            ...
            <div style={{ display: 'flex' }}>
              <span style={{ color: '#858585', width: '36px' }}>10</span>
              <span style={{ color: '#9CDCFE', marginLeft: '24px' }}>role</span>
              <span style={{ color: '#d4d4d4' }}>:</span>
